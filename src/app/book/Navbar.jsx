...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-row items-center justify-between w-full min-h-[60px] py-2 px-3 md:px-4">
      <div className="flex items-center">
        <Image
          ...
          height={50}
        />
        <span className="hidden min-[380px]:block ml-2 md:ml-5 mt-1 font-bold text-lg md:text-xl text-gray-900">BoilerBasket</span>
      </div>
