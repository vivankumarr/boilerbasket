...
export default function ExportsPage() {
  ...
  return (
    <div className="h-full overflow-y-auto p-8 w-full mx-auto space-y-8">
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 flex justify-between items-start w-full">
        <div>
          ...
          <button
            ...
            className="cursor-pointer bg-yellow-500 hover:bg-yellow-600 text-white px-6 py-2.5 rounded-lg font-medium flex items-center gap-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isExporting ? (
              <>
        ...
        <div className="space-y-6 relative">
          ...
          <div>
            ...
            <button
              ...
              className="w-full border border-gray-300 h-12 rounded-lg flex flex-row items-center justify-between px-4 hover:bg-slate-50 cursor-pointer transition-colors focus:ring-2 focus:ring-yellow-500"
            >
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full appearance-none bg-white border border-gray-300 rounded-lg p-3 text-gray-700 focus:ring-2 focus:ring-yellow-500 outline-none"
                >
